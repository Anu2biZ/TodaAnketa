  ...
  try {
    ...
    addLog('Папка создана: ' + userFolder.getName(), 'SUCCESS');
      ...
      const rowData = [
        ...
        params.urls,
        // Статусы файлов и комментарии
        params.processing_history,
        params.processing_history_comment || 'NO',
        params.chargeback_statistics,
        params.chargeback_statistics_comment || 'NO',
        params.incorporation,
        params.incorporation_comment || 'NO',
        params.incumbency,
        params.incumbency_comment || 'NO',
        params.articles,
        params.articles_comment || 'NO',
        params.ownershipChart,
        params.ownershipChart_comment || 'NO',
        params.boardOfDirectors,
        params.boardOfDirectors_comment || 'NO',
        params.shareholderRegister,
        params.shareholderRegister_comment || 'NO',
        params.operatingLicense,
        params.operatingLicense_comment || 'NO',
        params.amlPolicy,
        params.amlPolicy_comment || 'NO',
        params.mlroInformation,
        params.mlroInformation_comment || 'NO',
        params.kycDocuments,
        params.kycDocuments_comment || 'NO',
        params.legalEntityDocuments,
        params.legalEntityDocuments_comment || 'NO'
    ];
...
function handleFileUpload(params) {
  ...
  try {
    ...
    try {
      ...
      // Маппинг типов файлов и их комментариев на индексы колонок (нумерация с 1)
      const columnMapping = {
        'PROCESSING_HISTORY': 42,
        'processing_history_comment': 43,
        'CHARGEBACK_STATISTICS': 44,
        'chargeback_statistics_comment': 45,
        'INCORPORATION': 46,
        'incorporation_comment': 47,
        'INCUMBENCY': 48,
        'incumbency_comment': 49,
        'ARTICLES': 50,
        'articles_comment': 51,
        'OWNERSHIPCHART': 52,
        'ownershipChart_comment': 53,
        'BOARDOFDIRECTORS': 54,
        'boardOfDirectors_comment': 55,
        'SHAREHOLDERREGISTER': 56,
        'shareholderRegister_comment': 57,
        'OPERATINGLICENSE': 58,
        'operatingLicense_comment': 59,
        'AMLPOLICY': 60,
        'amlPolicy_comment': 61,
        'MLROINFORMATION': 62,
        'mlroInformation_comment': 63,
        'KYCDOCUMENTS': 64,
        'kycDocuments_comment': 65,
        'LEGALENTITYDOCUMENTS': 66,
        'legalEntityDocuments_comment': 67
      };
